    ...
    <motion.div
      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        <motion.div
          ...
          <p className='text-gray-600 mb-10'>Get ready to showcase your skills and experience in this comprehensive interview process. Improve communication, technical skills, and confidence.</p>
          <div className='space-y-5'>
            {
              [
                {
                  icon: <FaUserTie className='text-green-600 text-xl' />,
                  text: "Professional Interview Environment",
                },
                {
        ...
        <motion.div
          ...
          <div className='space-y-6'>
            ...
            <div className='relative'>
              ...
              <input type="text" name="experience" placeholder='Experience (e.g. 3 years in software development)'
            ...
            <select name="mode" id="mode" value={mode}
              ...
              className='w-full  pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'>
            ...
            {!analysisDone && (
              <motion.div
                ...
                <input type="file" name="resume" id="resumeUpload" accept="application/pdf"
                  onChange={(e) => setResumeFile(e.target.files[0])}
                  className='hidden' />
                <p className='text-gray-600 font-medium'>{resumeFile ? resumeFile.name : "Upload your resume"}</p>

                {resumeFile && (
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    onClick={(e) => { e.stopPropagation(); handleResumeUpload() }}
                    disabled={analyzing}
                    className='mt-4 bg-green-900 text-white py-2 px-4 rounded-xl hover:bg-green-800 transition'
                  >
            ...
            <motion.button
              ...
              //onClick={onStart}
              className='w-full disabled:bg-gray-500 bg-green-600 hover:bg-green-700 text-white py-3 rounded-full text-lg font-semibold duration-300 shadow-md transition'>
