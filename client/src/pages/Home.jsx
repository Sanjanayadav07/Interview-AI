          ...
          <div className="text-center mb-28">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="border border-gray-300 px-10 py-3 rounded-full hover:bg-gray-100"
              >
                View History
              </motion.button>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Behavioral and communication skills evaluation with HR-style questions.",
                },
                {
                  image: techImg,
                  title: "Technical Interview Mode",
                  desc: "Assessment of technical knowledge and problem-solving abilities.",
                },
                {
                  image: confidenceImg,
                  title: "Confidence Detection Mode",
                  desc: "Analyze body language and speech patterns to assess confidence levels.",
                },
                {
                  image: creditImg,
                  title: "Credits System",
                  desc: "Earn credits for each interview and redeem them for additional features or sessions.",
                },
              ].map((mode, index) => (
                <motion.div
                  key={index}
